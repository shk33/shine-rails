...
CREATE TABLE users (
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    CONSTRAINT email_must_be_valid CHECK (((email)::text ~* '^[^@]+@example\.com'::text))
);
...
INSERT INTO schema_migrations (version) VALUES ('20160715062409');

INSERT INTO schema_migrations (version) VALUES ('20160720040906');

INSERT INTO schema_migrations (version) VALUES ('20160720043320');

INSERT INTO schema_migrations (version) VALUES ('20160720064308');

INSERT INTO schema_migrations (version) VALUES ('20160805053238');

INSERT INTO schema_migrations (version) VALUES ('20160811035400');

INSERT INTO schema_migrations (version) VALUES ('20160812042846');
